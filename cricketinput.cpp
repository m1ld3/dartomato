...
cricketinput::cricketinput(QWidget *parent, int sets, int legs, cricketclass* player, CricketMainWindow* gamewindow, bool cutthroat)
    : QDialog(parent), ui(new Ui::cricketinput), Sets(sets), Legs(legs), Counter(3), Player(player), mGameWindow(gamewindow)
    , mSlot15(Player->getSlot15()), mSlot16(Player->getSlot16()), mSlot17(Player->getSlot17()), mSlot18(Player->getSlot18())
    , mSlot19(Player->getSlot19()), mSlot20(Player->getSlot20()), mSlot25(Player->getSlot25()), mExtra15(Player->getExtra15())
    , mExtra16(Player->getExtra16()), mExtra17(Player->getExtra17()), mExtra18(Player->getExtra18()), mExtra19(Player->getExtra19())
    , mExtra20(Player->getExtra20()), mExtra25(Player->getExtra25()), mScore(Player->getScore()), mCutThroat(cutthroat)
    , mExtra15s(mGameWindow->computeExtra15s(0, Player->get_player_name()))
    , mExtra16s(mGameWindow->computeExtra16s(0, Player->get_player_name()))
    , mExtra17s(mGameWindow->computeExtra17s(0, Player->get_player_name()))
    , mExtra18s(mGameWindow->computeExtra18s(0, Player->get_player_name()))
    , mExtra19s(mGameWindow->computeExtra19s(0, Player->get_player_name()))
    , mExtra20s(mGameWindow->computeExtra20s(0, Player->get_player_name()))
    , mExtra25s(mGameWindow->computeExtra25s(0, Player->get_player_name())), mSlot15Array({mSlot15}), mSlot16Array({mSlot16})
