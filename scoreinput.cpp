...
void ScoreInput::setScore(int value, QChar type, int checkout) {
    Score -= value;
...
void ScoreInput::signalSegmentPressed(int &value, QChar &type)
{
    ...
    void ScoreInput::signalUndoButtonPressed()
    {
        if (Counter < 3) {
...
ScoreInput::ScoreInput(QWidget *parent, int startval, int score, int sets, int legs, bool singleIn,
                       bool singleOut, bool doubleIn, bool doubleOut, bool masterIn, bool masterOut) :
    QDialog(parent),
