...
CStatsWindowX01* IStatsWindow::create(const CX01Class::CPlayerData& iPlayerData, QWidget* iParent)
{
  return new CStatsWindowX01(iPlayerData, iParent);
}

CStatsWindowCricket* IStatsWindow::create(const CCricketClass::CPlayerData& iPlayerData, QWidget* iParent)
{
